...
--
-- Host: localhost
-- Generation Time: Aug 31, 2019 at 02:12 PM
...
CREATE TABLE `books` (
  ...
  `book_title` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `book_author` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Category` varchar(255) DEFAULT NULL,
  `book_image` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `book_descr` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci,
...
CREATE TABLE `member` (
  ...
  `Status` enum('ADMIN','USER') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'USER'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `orders` (
  ...
  `ship_name` char(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ship_address` char(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ship_city` char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ship_zip_code` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ship_country` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `orders` (`orderid`, `customerid`, `amount`, `ship_name`, `ship_address`, `ship_city`, `ship_zip_code`, `ship_country`) VALUES
(1, 1, '60.00', 'a', 'a', 'a', 'a', 'a'),
(2, 2, '60.00', 'b', 'b', 'b', 'b', 'b'),
(3, 3, '20.00', 'test', '123 test', '12121', 'test', 'test'),
(4, 1, '20.00', 'a', 'a', 'a', 'a', 'a');
...
CREATE TABLE `publisher` (
  `publisherid` int(10) UNSIGNED NOT NULL,
  `publisher_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
